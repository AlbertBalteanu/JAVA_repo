...
import lab9.JDBC.entity.Continent;
...
public class ContinentDAO {
    ...
    public static int createContinent(Continent continent) throws SQLException {
    ...
    public static Continent getContinentById(int id) throws SQLException {
    ...
    public static Continent getContinentByName(String name) throws SQLException {
    ...
    private static Continent mapResultSetToContinent(ResultSet rs) throws SQLException {
