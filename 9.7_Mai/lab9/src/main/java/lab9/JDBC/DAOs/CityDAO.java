...
public class CityDAO {
    ...
    public static int createCity(City city) throws SQLException {
        String sql = "INSERT INTO cities (id, name, country, capital, latitude, longitude, population) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            pstmt.setInt(7, city.getPopulation());
    ...
    public static City getCityById(int id) throws SQLException {
        String sql = "SELECT id, name, country, capital, latitude, longitude, population FROM cities WHERE id = ?";
    ...
    public static City getCityByName(String name) throws SQLException {
        String sql = "SELECT id, name, country, capital, latitude, longitude, population FROM cities WHERE name LIKE ?";
    ...
    private static City mapResultSetToCity(ResultSet rs) throws SQLException {
        ...
        System.out.println("City: " + city.getName() + ", Country: " + city.getCountry() + ", Capital: " + city.isCapital() + ", Latitude: " + city.getLatitude() + ", Longitude: " + city.getLongitude() + ", Population: " + city.getPopulation());
        return city;
    }
}
